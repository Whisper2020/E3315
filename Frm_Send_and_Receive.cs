...
{
    public partial class Frm_Send_and_Receive : Form
    {
        #region 字段/属性
        ...
        private Port_Data_Send pchSend;
        private Port_Data_Send pchReceive;
        #endregion
        ...
        #region 事件
        public Frm_Send_and_Receive()
        {
            InitializeComponent();
            pchSend = new Port_Data_Send();
            pchReceive = new Port_Data_Send();
            InitView();
        }
        ...
        private void Btn_receive_Click(object sender, EventArgs e)
        {
            if (ReceiveState)
            {
                pchReceive.OnComReceiveDataHandler -= new Port_Data_Send.ComReceiveDataHandler(ComReceiveData);
        ...
        private void FrmPortControl_Load(object sender, EventArgs e)
        {
